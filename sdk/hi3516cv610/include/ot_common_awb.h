...
typedef struct {
    td_u16 hue_shift[OT_ISP_COLOR_SECTOR_NUM]; /* RW; Range: [0x0, 0xFFFF]; Format:8.8;CCM */
    td_u16 sat_shift[OT_ISP_COLOR_SECTOR_NUM];
} ot_isp_color_sector_tab; /* Not support for Hi3519DV500 */

typedef struct {
    td_bool valid;
    ot_isp_color_sector_tab color_tab[OT_ISP_CCM_MATRIX_NUM];
...
typedef struct {
    ...
    ot_isp_awb_ccm ccm;
    ot_isp_color_sector sector; /* Not support for Hi3519DV500 */
