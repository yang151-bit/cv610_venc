...
typedef struct {
    ...
    union {
        ot_isp_drc_mixing_bright_param local_mixing_bright_param; /* not support Hi3519DV500 */
        td_u8  local_mixing_bright[OT_ISP_DRC_LMIX_NODE_NUM]; /* RW; Range:[0x0, 0x80]; not support Hi3516CV610
                                                                LUT of enhancement coefficients for positive details */
    };
    union {
        ot_isp_drc_mixing_dark_param local_mixing_dark_param; /* not support Hi3519DV500 */
...
typedef struct {
    ...
    union {
        td_bool tnr_en;    /* RW; Range:[0, 1];Format:1.0; bayernr tnr enable. Not support for Hi3516CV610 */
        td_bool md_en;     /* RW; Range:[0, 1];Format:1.0; motion detection enable. Not support for Hi3519DV500 */
    };
    ...
    union {
        ot_isp_nr_tnr_attr   tnr_cfg;   /* Not support for Hi3516CV610 */
        ot_isp_nr_md_attr    md_cfg;    /* Not support for Hi3519DV500 */
    };
...
typedef struct {
    ...
    union {
        td_u8 nddm_hf_detail_strength; /* RW; Range:[0x0, 0x10]; Format:2.2;
                                          ...
                                          Not support for Hi3516CV610 */
        td_u8 hf_detail_strength; /* RW; Range:[0x0, 0x10]; Format:5.0; high frequent detail enhance strength
                                     Not support for Hi3519DV500 */
    };
...
typedef struct {
    ...
    td_u8   nddm_mf_detail_strength[OT_ISP_AUTO_ISO_NUM]; /* RW; Range:[0x0, 0x7f];
                                                             ...
                                                             enhance strength */
    union {
        td_u8 nddm_hf_detail_strength[OT_ISP_AUTO_ISO_NUM]; /* RW; Range:[0x0, 0x10]; Format:2.2;
                                                               Non-direction high frequent detail enhance strength
                                                               Not support for Hi3516CV610 */
...
typedef struct {
    td_bool  user_black_level_en; /* not support for Hi3516CV610 */
    td_u16   user_black_level[OT_ISP_WDR_MAX_FRAME_NUM][OT_ISP_BAYER_CHN_NUM];  /* RW; Range: [0x0, 0x3FFF];Format:14.0;
                                       ...
                                       the R,Gr, Gb, and B components respectively. not support for Hi3516CV610 */
...
typedef struct {
    ...
    td_u16  hl_cnt;        /* R; Range: Hi3519DV500 = [0x0, 0xFFFF] | Hi3516CV610 = [0x0, 0x7FFF]; HlCnt Statistics */
} ot_isp_focus_zone;
