...
typedef struct {
    ...
    td_u32 buf_line;    /* RW; Range: [128, chn_height]; chn wrap buffer line */
    td_u32 buf_size;    /* RW; chn wrap buffer size */
} ot_vpss_chn_buf_wrap_attr;

typedef struct {
    td_bool enable;         /* RW; Range: [0, 1] */
    td_u32 svc_interval;    /* RW; Range: [1, 10]; Mark one frame every svc_interval frames */
    ot_vpss_chn svc_chn;    /* RW; Range: [0, OT_VPSS_MAX_PHYS_CHN_NUM); Mark other chns based on svc chn */
} ot_vpss_svc_param;
