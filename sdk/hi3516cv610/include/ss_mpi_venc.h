...
td_s32 ss_mpi_venc_set_svc_param_ex(ot_venc_chn chn, const ot_venc_svc_param_ex *svc_param_ex);
td_s32 ss_mpi_venc_get_svc_param_ex(ot_venc_chn chn, ot_venc_svc_param_ex *svc_param_ex);
td_s32 ss_mpi_venc_send_svc_region(ot_venc_chn chn, const ot_venc_svc_rect_info *svc_region);
td_s32 ss_mpi_venc_send_svc_mask(ot_venc_chn chn, const ot_venc_svc_mask_info *svc_mask);
...
td_s32 ss_mpi_venc_set_svac3_trans(ot_venc_chn chn, const ot_venc_svac3_trans *svac3_trans);
td_s32 ss_mpi_venc_get_svac3_trans(ot_venc_chn chn, ot_venc_svac3_trans *svac3_trans);
td_s32 ss_mpi_venc_set_svac3_dblk(ot_venc_chn chn, const ot_venc_svac3_dblk *svac3_dblk);
td_s32 ss_mpi_venc_get_svac3_dblk(ot_venc_chn chn, ot_venc_svac3_dblk *svac3_dblk);
td_s32 ss_mpi_venc_set_svac3_sao(ot_venc_chn chn, const ot_venc_svac3_sao *svac3_sao);
